...
; https://raw.githubusercontent.com/Stefarling/PaliaHotkeys/main/Scripts/Universal/CelebrationCake-Batter.ahk
...
ButtonMake := "1600 1190"  ; Make button
...
TestScript() {              ; Shows where we'll click
    ...
    Sleep SleepTimer        ; Delay
    Click ButtonMake ", 0" ; Move mouse but don't click
    ShowClickIndicator()    ; Show tooltip
